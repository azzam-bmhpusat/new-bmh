...
const profil = [
  { name: 'Tentang Kami', description: 'Kenali lebih dekat visi, misi, dan komitmen BMH dalam membangun peradaban berbasis zakat.', href: '/profilbmh', icon: InformationCircleIcon },
...
const publikasi = [
  { name: 'Berita', description: 'Kumpulan berita terbaru seputar aktivitas, program, dan capaian BMH untuk masyarakat.', href: '/berita-bmh', icon: NewspaperIcon },
  { name: 'PID', description: 'Publikasi Inspirasi Dakwah (PID) berisi tulisan keislaman, renungan, dan dakwah bil qalam.', href: '/under-construction', icon: BookOpenIcon },
  { name: 'Riset & Pengembangan', description: 'Laporan riset dan inovasi pengembangan program BMH agar lebih tepat sasaran dan bermanfaat.', href: '/riset-pengembangan', icon: LightBulbIcon },
  { name: 'Laporan Keuangan', description: 'Transparansi pengelolaan dana BMH yang disajikan dalam bentuk laporan keuangan resmi dan dapat diakses publik.', href: '/laporan-keuangan', icon: BanknotesIcon },
  { name: 'Laporan Tahunan', description: 'Rangkuman kegiatan, capaian, dan kontribusi BMH selama satu tahun penuh dalam satu dokumen komprehensif.', href: '/laporan-tahunan', icon: CalendarDaysIcon },
];

const servicesMenu = [
  { names: 'Kalkulator Zakat', descriptions: 'Hitung zakatmu dengan mudah sesuai ketentuan syariah.', hrefs: '/kalkulator-zakat', icons: CalculatorIcon },
  { names: 'Jemput Zakat', descriptions: 'Layanan penjemputan zakat langsung ke lokasi Anda.', hrefs: '/jemput-zakat', icons: TruckIcon },
];
              ...
              <div className="grid grid-cols-2 divide-x divide-[#095046]/5 bg-gray-50">
                {callsToAction.map((item) => (
                  <a
                    ...
                    className="flex items-center justify-center gap-x-2.5 p-3 text-sm/6 font-semibold text-[#095046] hover:text-[#39BA87] transition-all duration-200 hover:bg-gray-100"
                  >
